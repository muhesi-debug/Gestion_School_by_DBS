...
INSERT INTO `courses`(`id_cours`,`descrption_cours`) VALUES
('Comp 1','Comptabilité');
...
INSERT INTO `frais`(`id_frais`,`montant`,`id_categ_frais`,`num_secope`,`code_option`,`code_class`,`id_annee_scol`) VALUES
(1,400,3,'0090','COGE','1er A',3);
...
INSERT INTO `inscrire`(`id_inscription`,`date_inscription`,`code_class`,`code_option`,`id_annee_scol`,`num_secope`,`student`) VALUES
(2,'2024-02-03 00:00:00','1er A','COGE',3,'0090','HEKA2/2024'),
(3,'2024-02-03 00:00:00','1er A','COGE',3,'0090','HEKA3/2024');
...
(3,'2024-01-02 00:00:00','2024-01-10 00:00:00',2,'Première période');
...
-- Dump completed on 2024-02-03 13:15:04
-- Total time: 0:0:0:2:9 (d:h:m:s:ms)
